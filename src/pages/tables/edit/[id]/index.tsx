      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="layout" mb="4" isInvalid={!!formik.errors?.layout}>
              <FormLabel>Layout</FormLabel>
              <Input type="text" name="layout" value={formik.values?.layout} onChange={formik.handleChange} />
              {formik.errors.layout && <FormErrorMessage>{formik.errors?.layout}</FormErrorMessage>}
            </FormControl>
